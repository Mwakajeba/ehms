                                ...
                                <div class="card border-info position-relative h-100">
                                    <div class="card-body text-center">
                                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-info">
                                            ...
                                            @endphp
                                            {{ $deprCount }}
                                            <span class="visually-hidden">depreciations count</span>
                                        </span>
                                        <div class="mb-3">
                                            <i class="bx bx-calculator fs-1 text-info"></i>
                                        </div>
                                        <h5 class="card-title">Depreciation</h5>
                                        <p class="card-text">Monthly scheduled, multiple methods.</p>
                                        <a href="{{ route('assets.depreciation.index') }}" class="btn btn-info">
                                            <i class="bx bx-calculator me-1"></i> Open Depreciation
                                        </a>
                                    </div>
                                </div>
                            </div>
