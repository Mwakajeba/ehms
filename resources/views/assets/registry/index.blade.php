                        ...
                        <div class="modal-body">
                            ...
                            <div class="alert alert-info">
                                ...
                                <small>
                                    ...
                                    - <strong>tax_pool_class</strong> is optional (e.g., Class 1, Class 2, Class 3, Class 5, Class 6, Class 7, Class 8). If omitted, it will be left blank.<br>
...
$(function() {
    const table = $('#assets-table').DataTable({
        ...
        columns: [
            ...
            { data: 'tax_pool_class', name: 'assets.tax_pool_class', defaultContent: '', render: function(d){
