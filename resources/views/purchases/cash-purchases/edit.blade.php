    ...
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('purchases.cash-purchases.update', $purchase->encoded_id) }}" id="cash-purchase-form">
                    @csrf
                    @method('PUT')
                                ...
                                <select class="form-select select2-single" id="currency" name="currency">
                                    @foreach($currencies as $currency)
                                        <option value="{{ $currency->currency_code }}" 
                                                {{ old('currency', $cashPurchase->currency ?? $functionalCurrency) == $currency->currency_code ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="exchange_rate" name="exchange_rate" value="{{ old('exchange_rate', number_format($cashPurchase->exchange_rate ?? 1, 6, '.', '')) }}" step="0.000001" min="0.000001" placeholder="1.000000">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    if ($cashPurchase->currency && $cashPurchase->currency != $functionalCurrency && $cashPurchase->exchange_rate && $cashPurchase->exchange_rate != 1) {
                                                        $originalPrice = $line->unit_cost * $cashPurchase->exchange_rate;
                                                    } else {
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        ...
        const purchaseCurrency = '{{ $cashPurchase->currency ?? "TZS" }}';
