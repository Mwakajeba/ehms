                                    ...
                                    <tbody>
                                        ...
                                        @forelse($transactions as $transaction)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($transaction->type == 'payment')
                                                        Payment#{{ $transaction->reference_id }} --- {{ $transaction->description }}
                                                    @elseif($transaction->type == 'debit_note')
                                                        Debit Note#{{ $transaction->reference_id }} --- {{ $transaction->description }}
                                                    @else
                                        ...
                                        <tr class="table-success fw-bold">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @if(isset($totalDebitNotes) && $totalDebitNotes > 0)
                                                    <br><small class="text-warning">(DN: {{ number_format($totalDebitNotes, 2) }})</small>
                                                @endif
                                            </td>
