                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="card border border-{{ $totalVariance >= 0 ? 'warning' : 'danger' }}">
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-{{ $totalVariance >= 0 ? 'warning' : 'danger' }}">Variance Qty</h5>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row['grn_date'] ? \Carbon\Carbon::parse($row['grn_date'])->format('Y-m-d') : 'N/A' }}</td>
                                        <td>{{ $row['po_number'] }}</td>
                                        ...
                                        <td class="text-end">{{ number_format($row['invoiced_quantity'], 2) }}</td>
                                        <td class="text-end {{ $row['variance'] > 0 ? 'text-warning' : ($row['variance'] < 0 ? 'text-danger' : 'text-success') }}">
                                            {{ number_format($row['variance'], 2) }}
                                        </td>
                                        <td class="text-end">{{ number_format($row['variance_percentage'], 2) }}%</td>
                                        <td>
                                            ...
                                            @elseif($row['variance_status'] === 'under_invoiced')
                                                <span class="badge bg-danger">Under Invoiced</span>
                                            @elseif($row['variance_status'] === 'over_invoiced')
                                                <span class="badge bg-info">Over Invoiced</span>
                                            @endif
                                        </td>
                                    </tr>
                                    @empty
                                    <tr><td colspan="12" class="text-center text-muted">No data found for the selected criteria.</td></tr>
                                    @endforelse
                                </tbody>
