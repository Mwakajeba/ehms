                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $row['po_number'] }}</td>
                                        <td>{{ $row['po_date'] ? \Carbon\Carbon::parse($row['po_date'])->format('Y-m-d') : 'N/A' }}</td>
                                        ...
                                        <td class="text-end">{{ number_format($row['fulfillment_percentage'], 2) }}%</td>
                                        <td>
                                    ...
                                    @empty
                                    <tr><td colspan="11" class="text-center text-muted">No data found for the selected criteria.</td></tr>
                                    @endforelse
                                </tbody>
