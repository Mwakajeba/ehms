                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $po->reference ?? ('PO-' . $po->id) }}</td>
                                        <td>{{ optional($po->order_date)->format('Y-m-d') }}</td>
                                        <td>{{ optional($po->supplier)->name }}</td>
                                        <td><span class="badge bg-{{ $po->status === 'approved' ? 'success' : ($po->status === 'closed' ? 'secondary' : 'warning') }}">{{ ucfirst($po->status) }}</span></td>
