                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center justify-content-between">
                            ...
                            <h5 class="mb-0 text-primary">Edit Subject</h5>
                            <div></div>
                        </div>
                        <hr />

                        <form action="{{ route('school.academics.subjects.update', $subject->hashid) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('short_name') is-invalid @enderror"
                                           id="short_name" name="short_name" value="{{ old('short_name', $subject->short_name) }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Describe the subject content, objectives, and what students will learn...">{{ old('description', $subject->description) }}</textarea>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('passing_marks') is-invalid @enderror"
                                           id="passing_marks" name="passing_marks" value="{{ old('passing_marks', $subject->passing_marks) }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('total_marks') is-invalid @enderror"
                                           id="total_marks" name="total_marks" value="{{ old('total_marks', $subject->total_marks) }}"
