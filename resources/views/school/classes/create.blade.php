...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">CREATE NEW CLASS</h6>
        <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add New School Class</h5>
                        </div>
                        <hr />
                        ...
                        <form action="{{ route('school.classes.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-save me-1"></i> Create Class
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="small text-muted">
                                ...
                                These can include nursery, kindergarten, primary grades, secondary classes, etc.
                            </p>
                        </div>
                        <div class="mb-3">
                            <h6>Examples:</h6>
                            <ul class="small text-muted">
                                ...
                                <li>Grade 1, Grade 2, Grade 3</li>
                                <li>Class 1, Class 2, Class 3</li>
                                <li>Standard 1, Standard 2</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        console.log('Create class form loaded');
    });
</script>
@endpush