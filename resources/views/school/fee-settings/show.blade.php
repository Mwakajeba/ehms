...
@section('title', 'Fee Setting Details')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">FEE SETTING DETAILS</h6>
        <hr />
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Fee Setting Information</h5>
                            </div>
                            <div>
                                <a href="{{ route('school.fee-settings.edit', $feeSetting) }}" class="btn btn-warning me-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td>{{ $feeSetting->classe->name ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                @if($feeSetting->feeSettingItems && $feeSetting->feeSettingItems->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @foreach($feeSetting->feeSettingItems as $item)
                                                    <tr>
                                                        <td>
                                                            @if($item->category === 'day')
                                                                <span class="badge bg-primary">
                                                                    <i class="bx bx-sun me-1"></i> Day Student
                                                                </span>
                                                            @elseif($item->category === 'boarding')
                                                                <span class="badge bg-success">
                                                                    <i class="bx bx-bed me-1"></i> Boarding Student
                                                                </span>
                                                            @else
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="text-center">
                                                    <h5 class="text-secondary">{{ $feeSetting->feeSettingItems ? $feeSetting->feeSettingItems->count() : 0 }}</h5>
