...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Edit Exam', 'url' => '#', 'icon' => 'bx bx-edit']
        ]" />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            <i class="bx bx-edit me-2 font-22 text-warning"></i>
                            <span class="h5 mb-0 text-warning">Edit Exam: {{ $exam->exam_name }}</span>
                        </div>
                        <hr />
                        ...
                        <div class="alert alert-warning">
                            ...
                            <strong>Warning:</strong> This exam is marked as completed. Editing may affect existing results and reports.
                        </div>
                        @endif
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> This exam is currently ongoing. Be careful when modifying schedule and marks.
                        </div>
                        @endif

                        <form id="examForm" action="{{ route('school.exams.update', $exam) }}" method="POST">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('exam_name') is-invalid @enderror"
                                                       id="exam_name" name="exam_name" value="{{ old('exam_name', $exam->exam_name) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror"
                                                          ...
                                                          placeholder="Optional description of the exam">{{ old('description', $exam->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('stream_id') is-invalid @enderror"
                                                    ...
                                                    <option value="{{ $stream->id }}" {{ old('stream_id', $exam->stream_id) == $stream->id ? 'selected' : '' }}>
                                                        {{ $stream->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control @error('exam_date') is-invalid @enderror"
                                                       id="exam_date" name="exam_date" value="{{ old('exam_date', $exam->exam_date ? $exam->exam_date->format('Y-m-d') : '') }}" required>
                                                @error('exam_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control @error('max_marks') is-invalid @enderror"
                                                               id="max_marks" name="max_marks" value="{{ old('max_marks', $exam->max_marks) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control @error('pass_marks') is-invalid @enderror"
                                                               id="pass_marks" name="pass_marks" value="{{ old('pass_marks', $exam->pass_marks) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('weight') is-invalid @enderror"
                                                       id="weight" name="weight" value="{{ old('weight', $exam->weight) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('instructions') is-invalid @enderror"
                                                          ...
                                                          placeholder="Enter exam instructions, rules, and guidelines">{{ old('instructions', $exam->instructions) }}</textarea>
                                                @error('instructions')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="{{ route('school.exams.show', $exam) }}" class="btn btn-outline-info me-2">
