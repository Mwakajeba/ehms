...
<head>
    ...
    <title>Late Submissions Report</title>
    <style>
        body {
...
<body>
    ...
    @if(count($data) > 0)
        <table class="data-table">
                ...
                @foreach($data as $index => $row)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @endphp
                            @if($days >= 7)
                                <span class="text-danger">{{ $days }} day(s)</span>
                            @elseif($days >= 3)
                                <span class="text-warning">{{ $days }} day(s)</span>
                            @else
                                <span class="text-info">{{ $days }} day(s)</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
            ...
            <tfoot>
                <tr>
                    <td colspan="9" style="text-align: right; font-weight: bold;">TOTAL LATE SUBMISSIONS:</td>
                    <td class="text-center text-danger" style="font-weight: bold;">{{ $totalLate }}</td>
                </tr>
                <tr>
                    <td colspan="9" style="text-align: right; font-weight: bold;">AVERAGE DAYS LATE:</td>
                    <td class="text-center" style="font-weight: bold;">
                        @php
                            $avgDays = $totalLate > 0 ? ($totalDaysLate / $totalLate) : 0;
                        @endphp
                        {{ number_format($avgDays, 2) }} days
                    </td>
                </tr>
            </tfoot>
        </table>
    @else
        <div class="no-data">
            ...
            <p>No late submissions found for the selected criteria.</p>
        </div>
    @endif
