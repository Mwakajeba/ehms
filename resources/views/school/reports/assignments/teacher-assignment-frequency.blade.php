...
@section('title', 'Teacher Assignment Frequency Report')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Teacher Assignment Frequency', 'url' => '#', 'icon' => 'bx bx-user']
        ]" />
        <h6 class="mb-0 text-uppercase">TEACHER ASSIGNMENT FREQUENCY REPORT</h6>
        <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Teacher Assignment Frequency Report</h5>
                        </div>
                        <hr />
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="teacherFrequencyTable" class="table table-striped table-bordered">
                        ...
                        <div id="reportPlaceholder" class="text-center py-5">
                            ...
                            <h5 class="text-muted">Teacher Assignment Frequency Report</h5>
                            <p class="text-muted">Select filters and click "Generate Report" to view teacher assignment frequency</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#academic_year_id, #subject_id').select2({
            theme: 'bootstrap-5',
            width: '100%',
            placeholder: 'Select...',
            allowClear: true
        ...
        $('#generateReportBtn').on('click', function() {
            ...
            table = $('#teacherFrequencyTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('school.reports.teacher-assignment-frequency') }}",
                    data: function(d) {
        ...
        $('#exportExcelBtn').on('click', function() {
            ...
            window.location.href = "{{ route('school.reports.teacher-assignment-frequency') }}?" + params.toString();
        });
