...
@section('title', 'Upload Library Material')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Upload Material', 'url' => '#', 'icon' => 'bx bx-plus']
        ]" />
        <h6 class="mb-0 text-uppercase">UPLOAD LIBRARY MATERIAL</h6>
        <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            <div><i class="bx bx-plus me-1 font-22 text-purple"></i></div>
                            <h5 class="mb-0 text-purple">Upload New Material</h5>
                        </div>
                        <hr />

                        <form action="{{ route('school.library.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="e.g., Mathematics Form 6 Notes" required>
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                            ...
                                            <option value="pdf_book" {{ old('type') == 'pdf_book' ? 'selected' : '' }}>PDF Book</option>
                                            <option value="notes" {{ old('type') == 'notes' ? 'selected' : '' }}>Notes</option>
                                            <option value="past_paper" {{ old('type') == 'past_paper' ? 'selected' : '' }}>Past Paper</option>
                            ...
                            <!-- File Upload -->
                            <h6 class="text-purple mb-3 mt-4"><i class="bx bx-file me-2"></i>File Upload</h6>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-purple">
                                    <i class="bx bx-upload me-1"></i> Upload Material
                                </button>
                            </div>
                        </form>
                    </div>
