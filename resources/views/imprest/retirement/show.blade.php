                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if($retirement->approvals && $retirement->approvals->count() > 0)
                                ...
                                @if($userPendingApproval)
                                    ...
                                    <a href="{{ route('imprest.retirement-multi-approvals.pending') }}" class="btn btn-warning">
                                        <i class="bx bx-clock me-1"></i> View Pending Approvals
                                    </a>
                                @endif

                                <a href="{{ route('imprest.retirement-multi-approvals.history', $retirement->id) }}" class="btn btn-outline-info">
                                    <i class="bx bx-history me-1"></i> View Approval History
                                </a>
                            @else
                                <!-- Legacy single-level approval actions -->
                                @if($canUserCheck ?? false)
                                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#checkModal">
                                    <i class="bx bx-check-circle me-1"></i> Check Retirement
                                </button>
                                @elseif($retirement->canBeChecked && $retirement->canBeChecked())
                                ...
                                @elseif($retirement->canBeApproved && $retirement->canBeApproved())
                                <div class="alert alert-warning alert-sm mb-2">
                                    <i class="bx bx-info-circle me-1"></i>
                            ...
                            <a href="{{ route('imprest.retirement.edit', $retirement->id) }}" class="btn btn-warning">
                                <i class="bx bx-edit me-1"></i> Edit Retirement
                            </a>
                            @endif

                            @if($retirement->status === 'closed' && $retirement->journal)
                            <a href="{{ route('accounting.journals.show', $retirement->journal_id) }}" class="btn btn-outline-info">
