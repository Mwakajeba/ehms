...
@section('title', 'Create Dental Bill')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Create Dental Bill', 'url' => '#', 'icon' => 'bx bx-smile']
        ]" />
        <h6 class="mb-0 text-uppercase">CREATE DENTAL BILL</h6>
        <hr />
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="dental-bill-form" method="POST" action="{{ route('hospital.doctor.store-dental-bill', $visit->id) }}">
                    @csrf

                    <div class="alert alert-info">
                        <i class="bx bx-info-circle me-2"></i>
                        <strong>Note:</strong> Select services for this patient. After creating the bill, the patient will be sent to the cashier for payment. Once paid, the patient can proceed to dental department.
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-info btn-sm" id="add-item" data-bs-toggle="modal" data-bs-target="#itemModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">Enter any additional notes or instructions for this service.</small>
                </div>
                <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" id="add-item-btn">Add Service</button>
            </div>
        </div>
    </div>
</div>
