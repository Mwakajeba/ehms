...
@section('title', 'Create Pharmacy Bill')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Create Pharmacy Bill', 'url' => '#', 'icon' => 'bx bx-capsule']
        ]" />
        <h6 class="mb-0 text-uppercase">CREATE PHARMACY BILL</h6>
        <hr />
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="pharmacy-bill-form" method="POST" action="{{ route('hospital.doctor.store-pharmacy-bill', $visit->id) }}">
                    @csrf

                    <div class="alert alert-info">
                        <i class="bx bx-info-circle me-2"></i>
                        <strong>Note:</strong> Select products (medications) for this patient. After creating the bill, the patient will be sent to the cashier for payment. Once paid, the patient can proceed to pharmacy.
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Products / Dawa</h6>
                                <button type="button" class="btn btn-success btn-sm" id="add-item" data-bs-toggle="modal" data-bs-target="#itemModal">
                                ...
                                <table class="table" id="items-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="20%">Description/Dosage</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="modal_item_id" class="form-label">Select Product</label>
                ...
                <div class="mb-3">
                    <label for="modal_description" class="form-label">Description/Dosage <span class="text-muted">(Optional)</span></label>
                    <textarea class="form-control" id="modal_description" rows="3" placeholder="Enter dosage instructions, e.g., Take 1 tablet twice daily after meals..."></textarea>
                    <small class="text-muted">Enter dosage instructions or any additional notes for this medication.</small>
                </div>
                <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="add-item-btn">Add Product</button>
            </div>
        </div>
    </div>
</div>
