...
@section('title', 'Create Injection Bill')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Create Injection Bill', 'url' => '#', 'icon' => 'bx bx-injection']
        ]" />
        <h6 class="mb-0 text-uppercase">CREATE INJECTION BILL</h6>
        <hr />
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="injection-bill-form" method="POST" action="{{ route('hospital.doctor.store-injection-bill', $visit->id) }}">
                    @csrf

                    <div class="alert alert-info">
                        <i class="bx bx-info-circle me-2"></i>
                        <strong>Note:</strong> Select services and products (injections) for this patient. After creating the bill, the patient will be sent to the cashier for payment. Once paid, the patient can proceed to vaccination department.
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-danger btn-sm" id="add-item" data-bs-toggle="modal" data-bs-target="#itemModal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="add-item-btn">Add Item</button>
            </div>
        </div>
    </div>
</div>
