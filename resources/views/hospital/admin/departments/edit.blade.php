...
@section('title', 'Edit Hospital Department')
...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <h6 class="mb-0 text-uppercase">EDIT HOSPITAL DEPARTMENT</h6>
            <hr />
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Hospital Department</h5>
                            </div>
                            <hr />
                            ...
                            <form action="{{ route('hospital.admin.departments.update', $department->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                                ...
                                                <option value="reception" {{ old('type', $department->type) == 'reception' ? 'selected' : '' }}>Reception</option>
                                                <option value="cashier" {{ old('type', $department->type) == 'cashier' ? 'selected' : '' }}>Cashier</option>
                                                <option value="triage" {{ old('type', $department->type) == 'triage' ? 'selected' : '' }}>Triage</option>
                                                ...
                                                <option value="family_planning" {{ old('type', $department->type) == 'family_planning' ? 'selected' : '' }}>Family Planning</option>
                                                <option value="vaccine" {{ old('type', $department->type) == 'vaccine' ? 'selected' : '' }}>Vaccine</option>
                                                <option value="injection" {{ old('type', $department->type) == 'injection' ? 'selected' : '' }}>Injection</option>
                                                <option value="observation" {{ old('type', $department->type) == 'observation' ? 'selected' : '' }}>Observation</option>
                                            </select>
                                            @error('type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
