...
@section('title', 'Vaccination Dashboard')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <x-breadcrumbs-with-icons :links="[
                ...
                ['label' => 'Vaccination', 'url' => '#', 'icon' => 'bx bx-shield']
            ]" />
            <h6 class="mb-0 text-uppercase">VACCINATION DASHBOARD</h6>
            <hr />
                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($waitingVisits as $visit)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $waitingTime }}</td>
                                                    <td>
                                                        <form action="{{ route('hospital.vaccination.start-service', $visit->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="btn btn-sm btn-primary">
                                                                <i class="bx bx-play me-1"></i>Start Service
                                                            </button>
                                                        </form>
                                                        <a href="{{ route('hospital.vaccination.create', $visit->id) }}" class="btn btn-sm btn-warning">
                                                            <i class="bx bx-plus me-1"></i>Record Vaccination
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mt-2">No patients waiting for vaccination services.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach($inServiceVisits as $visit)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $serviceTime }}</td>
                                                    <td>
                                                        <span class="badge bg-warning">{{ $visit->vaccinationRecords->count() }} record(s)</span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('hospital.vaccination.create', $visit->id) }}" class="btn btn-sm btn-warning">
                                                            <i class="bx bx-plus me-1"></i>Add Vaccination
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        ...
                                        <tbody>
                                            @foreach($followUpRequired as $record)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('hospital.vaccination.show', $record->id) }}" class="btn btn-sm btn-warning">
