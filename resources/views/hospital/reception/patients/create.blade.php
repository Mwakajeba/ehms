    ...
    <div class="page-wrapper">
        <div class="page-content">
            <x-breadcrumbs-with-icons :links="[
                ...
                ['label' => 'Register Patient', 'url' => '#', 'icon' => 'bx bx-plus']
            ]" />
            <h6 class="mb-0 text-uppercase">REGISTER NEW PATIENT</h6>
            <hr />
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Patient Registration Form</h5>
                            </div>
                            <hr />
                            ...
                            <form action="{{ route('hospital.reception.patients.store') }}" method="POST" id="patientForm">
                                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('allergies') is-invalid @enderror"
                                                          id="allergies" name="allergies" rows="2" placeholder="List any known allergies">{{ old('allergies') }}</textarea>
                                                @error('allergies')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bx bx-save me-1"></i>Register Patient
                                            </button>
                                        </div>
                                    </div>
                                </div>
