                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control tz-phone-input @error('phone') is-invalid @enderror"
                                                       id="phone" name="phone" value="{{ old('phone', $patient->phone) }}" placeholder="255655577803" maxlength="12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control tz-phone-input @error('next_of_kin_phone') is-invalid @enderror"
                                                       id="next_of_kin_phone" name="next_of_kin_phone" value="{{ old('next_of_kin_phone', $patient->next_of_kin_phone) }}" placeholder="255655577803" maxlength="12">
