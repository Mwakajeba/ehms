                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table-primary">
                                                        <td colspan="4" class="fw-bold text-dark"><i class="bx bx-folder me-1"></i>{{ $mainGroupName }}</td>
                                                    </tr>
                                                    @if(isset($mainGroup['fslis']))
                                                        @foreach($mainGroup['fslis'] as $fsliName => $fsli)
                                                        @if(isset($fsli['total']) && $fsli['total'] != 0)
                                                        <tr class="table-light">
                                                            <td colspan="4" class="ps-4 fw-medium text-dark">{{ $fsliName }}</td>
                                                        </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if(isset($mainGroup['fslis']))
                                                        ...
                                                        @if(isset($fsli['accounts']))
                                                            ...
                                                            @php 
                                                                // Sum using signed balances for correctness
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @php
                                                        // Get all unique accounts from both current and previous year
                                                        $allAccounts = [];
                                                        // Add current year accounts
                                                        foreach($financialReportData['chartAccountsRevenues'] ?? [] as $mainGroupName => $mainGroup) {
                                                            if(isset($mainGroup['fslis'])) {
                                                                foreach($mainGroup['fslis'] as $fsliName => $fsli) {
                                                                    if(isset($fsli['accounts'])) {
                                                                        foreach($fsli['accounts'] as $account) {
                                                                            $key = $mainGroupName . '|' . $fsliName . '|' . $account['account_id'];
                                                                            if(!isset($allAccounts[$key])) {
                                                                                $allAccounts[$key] = [
                                                                                    ...
                                                                                    'current_year' => $account['sum'] ?? 0,
                                                                                    'previous_year' => 0
                                                                                ];
                                                                            } else {
                                                                                $allAccounts[$key]['current_year'] = $account['sum'] ?? 0;
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        // Add previous year accounts (if not already in list)
                                                        foreach($previousYearData['chartAccountsRevenues'] ?? [] as $mainGroupName => $mainGroup) {
                                                            if(isset($mainGroup['fslis'])) {
                                                                foreach($mainGroup['fslis'] as $fsliName => $fsli) {
                                                                    if(isset($fsli['accounts'])) {
                                                                        foreach($fsli['accounts'] as $account) {
                                                                            ...
                                                                            if(!isset($allAccounts[$key])) {
                                                                                $allAccounts[$key] = [
                                                                                    ...
                                                                                    'account_code' => $account['account_code'] ?? '',
                                                                                    'current_year' => 0,
                                                                                    'previous_year' => $account['sum'] ?? 0
                                                                                ];
                                                                            } else {
                                                                                $allAccounts[$key]['previous_year'] = $account['sum'] ?? 0;
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        // Group by main group and fsli
                                                        $groupedAccounts = [];
                                                        foreach($allAccounts as $account) {
                                                            $mg = $account['main_group'];
                                                            $fsli = $account['fsli'];
                                                            if(!isset($groupedAccounts[$mg])) {
                                                                $groupedAccounts[$mg] = [];
                                                            }
                                                            if(!isset($groupedAccounts[$mg][$fsli])) {
                                                                $groupedAccounts[$mg][$fsli] = [];
                                                            }
                                                            $groupedAccounts[$mg][$fsli][] = $account;
                                                        }
                                                    @endphp
                                                    @foreach($groupedAccounts as $mainGroupName => $fslis)
                                                    @if(!empty($fslis))
                                                    <tr class="table-primary">
                                                        <td colspan="4" class="fw-bold text-dark"><i class="bx bx-folder me-1"></i>{{ $mainGroupName }}</td>
                                                    </tr>
                                                    @foreach($fslis as $fsliName => $accounts)
                                                    @if(!empty($accounts))
                                                        <tr class="table-light">
                                                            <td colspan="4" class="ps-4 fw-medium text-dark">{{ $fsliName }}</td>
                                                        </tr>
                                                    @foreach($accounts as $account)
                                                    @if($account['current_year'] != 0 || $account['previous_year'] != 0)
                                                    @php 
                                                        $sumRevenue += $account['current_year'];
                                                        $sumRevenuePrev += $account['previous_year'];
                                                        $change = $account['current_year'] - $account['previous_year'];
                                                            @endphp
                                                            <tr class="account-row">
                                                                <td class="ps-5">
                                                            ...
                                                            <a href="{{ route('accounting.transactions.doubleEntries', Hashids::encode($account['account_id'])) }}"
                                                                        class="text-decoration-none fw-bold text-dark">
                                                                {{ number_format($account['current_year'],2) }}
                                                                    </a>
                                                                </td>
                                                                <td class="text-end text-dark">
                                                            {{ number_format($account['previous_year'],2) }}
                                                                </td>
                                                                <td class="text-end">
                                                                        {{ $change >= 0 ? '+' : '' }}{{ number_format($change,2) }}
                                                                </td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @php
                                                        // Get all unique expense accounts from both current and previous year
                                                        $allExpenseAccounts = [];
                                                        // Add current year accounts
                                                            ...
                                                            if(isset($mainGroup['fslis'])) {
                                                                foreach($mainGroup['fslis'] as $fsliName => $fsli) {
                                                                    if(isset($fsli['accounts'])) {
                                                                        foreach($fsli['accounts'] as $account) {
                                                                            $key = $mainGroupName . '|' . $fsliName . '|' . $account['account_id'];
                                                                            if(!isset($allExpenseAccounts[$key])) {
                                                                                $allExpenseAccounts[$key] = [
                                                                                    'main_group' => $mainGroupName,
                                                                                    'fsli' => $fsliName,
                                                                                    'account_id' => $account['account_id'],
                                                                                    'account_name' => $account['account'],
                                                                                    'account_code' => $account['account_code'] ?? '',
                                                                                    'current_year' => abs($account['sum'] ?? 0),
                                                                                    'previous_year' => 0
                                                                                ];
                                                                            } else {
                                                                                $allExpenseAccounts[$key]['current_year'] = abs($account['sum'] ?? 0);
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        // Add previous year accounts (if not already in list)
                                                        foreach($previousYearData['chartAccountsExpense'] ?? [] as $mainGroupName => $mainGroup) {
                                                            if(isset($mainGroup['fslis'])) {
                                                                foreach($mainGroup['fslis'] as $fsliName => $fsli) {
                                                                    if(isset($fsli['accounts'])) {
                                                                        foreach($fsli['accounts'] as $account) {
                                                                            ...
                                                                            if(!isset($allExpenseAccounts[$key])) {
                                                                                $allExpenseAccounts[$key] = [
                                                                                    ...
                                                                                    'account_code' => $account['account_code'] ?? '',
                                                                                    'current_year' => 0,
                                                                                    'previous_year' => abs($account['sum'] ?? 0)
                                                                                ];
                                                                            } else {
                                                                                $allExpenseAccounts[$key]['previous_year'] = abs($account['sum'] ?? 0);
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        // Group by main group and fsli
                                                        $groupedExpenseAccounts = [];
                                                        foreach($allExpenseAccounts as $account) {
                                                            $mg = $account['main_group'];
                                                            $fsli = $account['fsli'];
                                                            if(!isset($groupedExpenseAccounts[$mg])) {
                                                                $groupedExpenseAccounts[$mg] = [];
                                                            }
                                                            if(!isset($groupedExpenseAccounts[$mg][$fsli])) {
                                                                $groupedExpenseAccounts[$mg][$fsli] = [];
                                                            }
                                                            $groupedExpenseAccounts[$mg][$fsli][] = $account;
                                                        }
                                                    @endphp
                                                    @foreach($groupedExpenseAccounts as $mainGroupName => $fslis)
                                                    @if(!empty($fslis))
                                                    <tr class="table-primary">
                                                        <td colspan="4" class="fw-bold text-dark"><i class="bx bx-folder me-1"></i>{{ $mainGroupName }}</td>
                                                    </tr>
                                                    ...
                                                    @if($account['current_year'] != 0 || $account['previous_year'] != 0)
                                                    @php 
                                                        $sumExpense += $account['current_year'];
                                                        $sumExpensePrev += $account['previous_year'];
                                                        $change = $account['current_year'] - $account['previous_year'];
                                                            @endphp
                                                            <tr class="account-row">
                                                                <td class="ps-5">
