                                ...
                                <div id="category_selection_section" style="display: {{ old('apply_to_all_employees', $statutoryRule->apply_to_all_employees ?? true) ? 'none' : 'block' }};">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                            ...
                                            value="{{ old('category_name', $statutoryRule->category_name) }}" 
                                            placeholder="e.g., Permanent Employees, Management Level">
                                        <small class="text-muted">Optional: A descriptive name for this category rule</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" 
                                            ...
                                            rows="2" 
                                            placeholder="Describe which employees this rule applies to...">{{ old('category_description', $statutoryRule->category_description) }}</textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Select Employee Categories</label>
                                                ...
                                                @foreach($statutoryRule->employeeCategories as $index => $category)
                                                    <div class="category-row mb-3 border rounded p-3" data-index="{{ $index }}">
                                                        ...
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-8">
                                                                <label class="form-label small">Category Value <span class="text-danger">*</span></label>
...
$(document).ready(function() {
    ...
    // Form submission - convert PAYE brackets to JSON
