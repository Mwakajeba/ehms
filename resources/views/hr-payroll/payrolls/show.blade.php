                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-sm mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">TZS {{ number_format($payroll->total_salary ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Allowances:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_allowance ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Overtime:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->payrollEmployees->sum('overtime') ?? 0, 2) }}</td>
                                        </tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm mb-0">
                                    <tbody>
                                        <tr>
                                            <td class="fw-bold">NHIF (Employer):</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_nhif_employer ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Pension (Employer):</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_pension_employer ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">WCF:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_wcf ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">SDL:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_sdl ?? 0, 2) }}</td>
                                        </tr>
                                        <tr class="table-info">
                                            <td class="fw-bold fs-6">Total Employer Contributions:</td>
                                            <td class="text-end fw-bold fs-6">TZS {{ number_format($payroll->total_employer_contributions ?? 0, 2) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm mb-0">
                                    <tbody>
                                        <tr>
                                            <td class="fw-bold">NHIF (Employee):</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_nhif_employee ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Pension (Employee):</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_pension_employee ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">PAYE:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_payee ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">HESLB:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_heslb ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Trade Union:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_trade_union ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Salary Advance:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_salary_advance_paid ?? 0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">External Loan:</td>
                                            <td class="text-end">TZS {{ number_format($payroll->total_external_loan_paid ?? 0, 2) }}</td>
                                        </tr>
