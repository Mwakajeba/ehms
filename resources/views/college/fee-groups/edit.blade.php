...
@section('title', 'Edit College Fee Group')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">EDIT COLLEGE FEE GROUP</h6>
        <hr />
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('college.fee-groups.update', $feeGroup->hashid) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $feeGroup->name) }}" placeholder="e.g., Tuition Fees, Examination Fees, Lab Fees" required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter description for this fee group">{{ old('description', $feeGroup->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        console.log('College fee group edit form loaded with Select2');
    });
</script>
@endpush