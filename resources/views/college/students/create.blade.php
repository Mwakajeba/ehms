                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            <h6><i class="bx bx-bulb me-1"></i> Tips for Creating Students:</h6>
                            <ul class="mb-0 small">
                                <li>Student number is auto-generated from names</li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add New College Student</h5>
                        </div>
                        <hr />
                                                ...
                                                <select class="form-control @error('enrollment_year') is-invalid @enderror"
                                                    ...
                                                    @foreach($academicYears as $year)
                                                        @php
                                                            ...
                                                            $isSelected = old('enrollment_year') ? (old('enrollment_year') == $startYear) : ($defaultEnrollmentYear == $startYear);
                                                        @endphp
                                                        <option value="{{ $startYear }}" {{ $isSelected ? 'selected' : '' }}>
                                                            {{ $year->year_name }}
                                                            @if($year->is_current)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2-multiple @error('courses') is-invalid @enderror"
                                                    ...
                                                    @foreach($courses as $course)
                                                        <option value="{{ $course->id }}" {{ (is_array(old('courses')) && in_array($course->id, old('courses'))) ? 'selected' : '' }}>
                                                ...
                                                <div class="form-text text-muted">
                                                    <i class="bx bx-info-circle me-1"></i>
                                                    Select multiple courses the student will enroll in
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control @error('emergency_contact_relationship') is-invalid @enderror"
                                                    ...
                                                    <option value="guardian" {{ old('emergency_contact_relationship') == 'guardian' ? 'selected' : '' }}>Guardian</option>
                                                    ...
                                                    <option value="relative" {{ old('emergency_contact_relationship') == 'relative' ? 'selected' : '' }}>Other Relative</option>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bx bx-save me-1"></i> Create Student
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    console.log('Enhanced college student creation form loaded');
...
function resetForm() {
    if (confirm('Are you sure you want to reset the form? All entered data will be lost.')) {
        ...
        $('#enrollment_year').val('').trigger('change');
        $('#status').val('').trigger('change');
        $('#gender').val('').trigger('change');
        $('#emergency_contact_relationship').val('').trigger('change');
