...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">EDIT DOCUMENT CATEGORY</h6>
        <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Document Category</h5>
                        </div>
                        <hr />

                        <form action="{{ route('college.document-categories.update', $documentCategory->id) }}" method="POST" id="documentCategoryForm">
                            @csrf
                            @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            <h6><i class="bx bx-bulb me-1"></i> Tips for Editing Categories:</h6>
                            <ul class="mb-0 small">
                        ...
                        <div class="alert alert-light">
                            <h6><i class="bx bx-time me-1"></i> Category Details:</h6>
                            <ul class="mb-0 small">
                                <li><strong>Created:</strong> {{ $documentCategory->created_at->format('M d, Y H:i') }}</li>
                                <li><strong>Created By:</strong> {{ $documentCategory->creator->name ?? 'N/A' }}</li>
                                <li><strong>Company:</strong> {{ $documentCategory->company->name ?? 'N/A' }}</li>
                                @if($documentCategory->branch)
                                    <li><strong>Branch:</strong> {{ $documentCategory->branch->name }}</li>
                                @endif
                            </ul>
                        </div>
                    </div>
...
$(document).ready(function() {
    console.log('Document category edit form loaded');
...
function resetForm() {
    if (confirm('Are you sure you want to reset the form? All changes will be lost.')) {
        $('#name').val('{{ $documentCategory->name }}');
        $('#code').val('{{ $documentCategory->code }}');
