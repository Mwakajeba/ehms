...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Departments', 'url' => '#', 'icon' => 'bx bx-group']
        ]" />
        <h6 class="mb-0 text-uppercase">DEPARTMENTS MANAGEMENT</h6>
        <hr />
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">College Departments</h5>
                            </div>
                            <a href="{{ route('college.departments.create') }}" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        ...
        try {
            $('#departments-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("college.departments.data") }}',
                    type: 'GET',
                    headers: {
            ...
            console.log('Departments DataTable initialized');
        } catch (error) {
    ...
    function confirmDelete(id, name) {
        ...
        $('#deleteForm').attr('action', '{{ url("college/departments") }}/' + id);
