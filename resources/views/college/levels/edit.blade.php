...
<div class="levels-container">
    ...
    <div class="page-header-card">
        <div class="header-content">
            ...
            <p class="header-subtitle">Update: {{ $level->name }}</p>
        </div>
    </div>

    <form action="{{ route('college.levels.update', $level) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                               value="{{ old('name', $level->name) }}" placeholder="e.g., Bachelor's Degree" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="short_name" class="form-control @error('short_name') is-invalid @enderror" 
                               value="{{ old('short_name', $level->short_name) }}" placeholder="e.g., BSc" required maxlength="20">
                        @error('short_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                               value="{{ old('code', $level->code) }}" placeholder="e.g., BSCDEG" maxlength="20">
                        @error('code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror" 
                               value="{{ old('sort_order', $level->sort_order) }}" min="0">
                        @error('sort_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="category-grid">
                        ...
                        @foreach($categories as $key => $value)
                            <label class="category-card {{ old('category', $level->category) == $key ? 'selected' : '' }}">
                                <input type="radio" name="category" value="{{ $key }}" 
                                       {{ old('category', $level->category) == $key ? 'checked' : '' }} required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                              placeholder="Brief description of this level...">{{ old('description', $level->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-container">
                        <div class="toggle-switch {{ old('is_active', $level->is_active) ? 'active' : '' }}" onclick="toggleStatus(this)">
            ...
            <div class="action-buttons">
                ...
                <button type="submit" class="btn-submit">
                    <i class="bx bx-save"></i> Update Level
                </button>
            </div>
        </div>
    </form>
