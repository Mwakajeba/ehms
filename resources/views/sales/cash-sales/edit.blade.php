...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sales.cash-sales.update', $cashSale->encoded_id) }}" id="cash-sale-form">
                    @csrf
                    @method('PUT')
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    Swal.fire('Error', 'An error occurred while updating the cash sale', 'error');
                }
            }
        });
    });
    ...
    // Initialize item counter
    let itemCounter = {{ $cashSale->items->count() }};
