...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sales.cash-sales.store') }}" id="cash-sale-form">
                    @csrf
...
$(document).ready(function() {
    ...
    function addItemToTable() {
        ...
        if (quantity > availableStock) {
            Swal.fire('Error', `Insufficient stock for ${itemName}. Available: ${availableStock}, Requested: ${quantity}`, 'error');
            return;
        }
