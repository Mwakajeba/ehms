                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="payment_method" name="payment_method" required>
                                            ...
                                            <option value="bank" {{ old('payment_method', $payment->bank_account_id ? 'bank' : 'cash_deposit') == 'bank' ? 'selected' : '' }}>Bank or Cash Payment</option>
                                            <option value="cash_deposit" {{ old('payment_method', $payment->bank_account_id ? 'bank' : 'cash_deposit') == 'cash_deposit' ? 'selected' : '' }}>Customer Deposits</option>
                                        </select>
