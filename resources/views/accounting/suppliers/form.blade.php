                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tin_number"
                                ...
                                placeholder="Enter TIN number" pattern="[A-Za-z0-9]+">
                            <div class="form-text">Enter letters and numbers only (no dashes or special characters)</div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="vat_number"
                                ...
                                placeholder="Enter VAT number" pattern="[A-Za-z0-9]+">
                            <div class="form-text">Enter letters and numbers only (no dashes or special characters)</div>
...
@push('scripts')
    <script>
        ...
        // TIN and VAT number validation - allow letters and numbers only
