...
$(document).ready(function() {
    ...
    $('#approve-btn').on('click', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to approve this schedule? Once approved, it will be activated and journals can be posted.',
            icon: 'question',
            showCancelButton: true,
    ...
    $('#reject-btn').on('click', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to reject this schedule? It will be returned to draft status.',
            icon: 'warning',
            showCancelButton: true,
