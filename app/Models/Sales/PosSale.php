...
class PosSale extends Model
{
    ...
    public function createDoubleEntryTransactions()
    {
        ...
        // 2. Credit Sales Revenue - Calculate to ensure exact balance
        // Sales Revenue = Total Amount - VAT - Withholding Tax
        // This ensures debits and credits balance exactly, absorbing any rounding differences
        $subtotalLCY = round($totalAmountLCY - $vatAmountLCY - $whtAmountLCY, 2);
        $transactions[] = [
