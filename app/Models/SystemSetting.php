...
class SystemSetting extends Model
{
    ...
    public static function initializeDefaults()
    {
        $defaults = [
            ...
            'security_content_security_policy' => ['value' => "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://code.jquery.com https://cdn.jsdelivr.net https://cdn.datatables.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net https://cdn.datatables.net; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https:; connect-src 'self'; frame-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self';", 'type' => 'string', 'group' => 'security', 'label' => 'Content Security Policy', 'description' => 'Content Security Policy header (set to "disabled" to disable). Default allows jQuery, CDN resources, and inline scripts needed for menu functionality.'],
            ...
            'rate_limit_login_attempts' => ['value' => 5, 'type' => 'integer', 'group' => 'security', 'label' => 'Login Rate Limit (attempts)', 'description' => 'Maximum login attempts allowed per IP address'],
