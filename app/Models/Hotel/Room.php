...
class Room extends Model
{
    ...
    /**
     * Resolve the model instance for route model binding using hash ID when explicitly requested.
     */
    public function resolveRouteBinding($value, $field = null)
    {
        // Only decode when the route explicitly binds by 'hash_id'
        if ($field === 'hash_id') {
    ...
    /**
     * Get the route key for the model (default to primary key value).
     */
    ...
    /**
     * Use default key name 'id' for implicit route model binding.
     */
