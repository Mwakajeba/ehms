...
class AssetRegistryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('assets.registry.create', compact('categories', 'departments', 'taxPools'));
    }
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->rawColumns(['hfs_status_display', 'depreciation_stopped_display'])
            ->make(true);
    }
    ...
    public function edit($id)
    {
        ...
        return view('assets.registry.edit', compact('asset','categories','departments', 'taxPools'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $asset = Asset::create(array_merge($payload, [
            ...
            'branch_id' => $branchId,
            'tax_pool_class' => $request->input('tax_pool_class'),
            'created_by' => $user->id,
        ]));
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            foreach ($rows as $rowIndex => $row) {
                ...
                // Parse tax pool class from CSV (prefer 'tax_pool_class', fallback to 'class')
                $csvTaxPoolClass = trim($data['tax_pool_class'] ?? ($data['class'] ?? '')) ?: null;
                ...
                try {
                    $asset = Asset::create([
                        ...
                        'tax_pool_class' => $csvTaxPoolClass,
                        'name' => trim($data['name']),
