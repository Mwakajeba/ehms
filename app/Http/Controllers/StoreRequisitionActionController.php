...
class StoreRequisitionActionController extends Controller
{
    ...
    public function return(Request $request, $id)
    {
        try {
            ...
            if ($requisition->status !== 'fully_issued') {
                return response()->json([
                    'success' => false,
                    'message' => 'Only fully issued requisitions can be returned.'
                ], 400);
            }
            ...
            $request->validate([
                ...
                'return_items.*.inventory_item_id' => 'required|exists:inventory_items,id'
            ]);
            ...
            \App\Models\StoreRequisitionReturn::create([
                'store_requisition_id' => $requisition->id,
                'return_date' => now(),
