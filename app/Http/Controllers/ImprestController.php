...
class ImprestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = Auth::user();
            ...
            if (!$branchId) {
                return back()->withInput()->withErrors(['error' => 'Please select a branch before creating an imprest request.']);
            }
    ...
    public function show($id)
    {
        ...
        $imprestRequest = ImprestRequest::with([
            'employee', 'department', 'creator', 'checker', 'approver', 'rejecter', 'disburser',
            'imprestItems.chartAccount',
            'payment.bankAccount', 'payment.paymentItems.chartAccount',
            'disbursement.bankAccount', 'disbursement.issuer',
            'liquidation.liquidationItems.chartAccount', 'liquidation.submitter', 'liquidation.verifier', 'liquidation.approver',
            'documents.uploader', 'journalEntries.debitAccount', 'journalEntries.creditAccount'
        ...
        $requiredApprovalLevels = $imprestRequest->getRequiredApprovalLevels();
    ...
    public function closedRequests(Request $request)
    {
        ...
        return view('imprest.closed.index');
    }
