...
class ApprovalLevelsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'module' => 'required|in:budget,bank_reconciliation,asset_revaluation,asset_impairment,asset_disposal,hfs_request,purchase_requisition',
    ...
    public function reorder(Request $request)
    {
        ...
        $request->validate([
            'module' => 'required|in:budget,bank_reconciliation,asset_revaluation,asset_impairment,asset_disposal,hfs_request',
