...
class StatutoryRuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Process employee categories if not applying to all employees
            if (!$validated['apply_to_all_employees'] && $request->has('employee_categories')) {
    ...
    public function edit(StatutoryRule $statutoryRule)
    {
        ...
        $statutoryRule->load('employeeCategories');
    ...
    public function update(Request $request, StatutoryRule $statutoryRule)
    {
        ...
        try {
            ...
            if (!$validated['apply_to_all_employees'] && $request->has('employee_categories')) {
                $this->syncEmployeeCategories($statutoryRule, $request->employee_categories);
            } elseif ($validated['apply_to_all_employees']) {
                // Remove all categories if applying to all employees
