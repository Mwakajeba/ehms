...
class OrderController extends Controller
{
    ...
    public function grnPrint(GoodsReceipt $grn)
    {
        ...
        // Render HTML suitable for both direct print and PDF generation using system document settings
        return view('purchases.grn.pdf', compact('grn'));
    }
    ...
    public function print($encodedId)
    {
        ...
        $pdf = Pdf::loadView('purchases.orders.print', compact('order'));
