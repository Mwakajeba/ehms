...
class SupplierController extends Controller
{
    ...
    {
        // Normalize phone before validation to ensure consistent 12-digit format (e.g., 07.. -> 2557.., +255.. -> 255..)
        ...
        $validator = Validator::make($request->all(), [
            ...
            'tin_number' => 'nullable|string|max:50|regex:/^[A-Za-z0-9]+$/',
            ...
            'tin_number.regex' => 'TIN number must contain only letters and numbers.',
            'vat_number.regex' => 'VAT number must contain only letters and numbers.',
        ]);
