...
class RetirementController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('department_name', function ($retirement) {
                return $retirement->imprestRequest->department->name ?? 'N/A';
            })
            ->addColumn('purpose', function ($retirement) {
                return $retirement->imprestRequest->purpose ?? 'N/A';
            })
            ->addColumn('status_badge', function ($retirement) {
                return '<span class="' . $retirement->getStatusBadgeClass() . '">' . $retirement->getStatusLabel() . '</span>';
            })
