...
7. **Content Security Policy** (`security_content_security_policy`)
   ...
   - Description: CSP header value (set to "disabled" to disable)
...
2. **ForceHttps** - Prepended early in the middleware stack
3. **SecurityHeaders** - Appended to add headers to all responses
4. **ApplySystemSettings** - Applies secure cookie configuration
